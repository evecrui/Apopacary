...
public class Request : MonoBehaviour
{
    ...
    public (Ingredient.Strength, Ingredient.TeaType) waterFlav;
    public Ingredient.Balls ball;
    public Ingredient.Waters water;
    public Ingredient.Sweetness sweetness;
    public Ingredient.Infusion sweetnessInfusion;
    public Ingredient.Milks milk;
    public Ingredient.Infusion milkInfusion;
    public Ingredient.Syruped syrup;
